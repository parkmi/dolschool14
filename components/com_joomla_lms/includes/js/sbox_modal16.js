...
var jlmsSqueezeBox = {
	...
	assign: function(to, options) {
		return ($(to) || $$(to)).addEvent('click', function() {
			return !jlmsSqueezeBox.fromElement(this, options);
		});
	},
...
jlmsSqueezeBox.extend(new Events($empty)).extend(new Options($empty)).extend(new Chain($empty));

jlmsSqueezeBox.parsers.extend({
...
jlmsSqueezeBox.handlers.extend({
...
jlmsSqueezeBox.handlers.url = jlmsSqueezeBox.handlers.ajax;
jlmsSqueezeBox.parsers.url = jlmsSqueezeBox.parsers.ajax;
jlmsSqueezeBox.parsers.adopt = jlmsSqueezeBox.parsers.clone;