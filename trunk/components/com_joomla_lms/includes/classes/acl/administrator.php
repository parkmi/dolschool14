<?php 
/**
* includes/classes/acl/administrator.php
...
function & JLMS_get_administrator_role() {
	$role = array();
	...
	$role['advanced'] = & $permissions_advanced;
		...
		$permissions_lms->create_course = 1;
		$permissions_lms->order_courses = 1;
	$role['lms'] = & $permissions_lms;
		...
		$permissions_docs->set_permissions = 1;
		$permissions_docs->ignore_permissions = 1;
	...
	$role['lpaths'] = & $permissions_lpaths;
		...
		$permissions_announce->only_own_items = 0;
		$permissions_announce->only_own_role = 0;
	$role['announce'] = & $permissions_announce;
		...
		$permissions_dropbox->send_to_learners = 1;
		$permissions_dropbox->mark_as_corrected = 1;
	...
	$role['mailbox'] = & $permissions_mail;
		...
		$permissions_users->manage_teachers = 1;
		$permissions_users->view = 1;
		$permissions_users->import_users = 1;
	...
	$role['course'] = & $permissions_course;
		...
		$permissions_library->view_all = 1;
		$permissions_library->order = 1;
		$permissions_library->publish = 1;
		$permissions_library->manage = 1;
		$permissions_library->manage_all = 1;
