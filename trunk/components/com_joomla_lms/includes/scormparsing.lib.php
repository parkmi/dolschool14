...
{
   global $inorg,$initem,$inmeta,$ingeneral,$intitle,$inversion,$prereq,$items;
...
function characterData($parser, $data)
{
   ...
   if (($intitle==true) and ($initem==true)) {
   	if (isset($items[$itemindex]['title'])) {
		$items[$itemindex]['title'].=$data;
	} else {$items[$itemindex]['title']=$data;}
		return;
 	}
   if ($inversion==true) {
