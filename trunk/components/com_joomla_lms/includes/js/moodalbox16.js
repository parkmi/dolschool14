...
/*    optimized for JoomlaLMS by DEN, k6.2.300 [at] gmail.com     */
/******************************************************************/
...
//		this.closelink.onclick = this.overlay.onclick = this.close.bind(this);
		...
		this.fx = {
			overlay: 	this.overlay.get('opacity', { duration: 500 })/*.hide()*/,
			resize: 	new Fx.Morph(this.center, { duration: this.options.resizeDuration, onComplete: nextEffect }),
			contents: 	this.contents.get('opacity', { duration: 500, onComplete: nextEffect }),
			bottom: 	new Fx.Morph(this.bottom, { duration: 400, onComplete: nextEffect })
		};
...
// startup
//Window.onDomReady(MOOdalBox.init.bind(MOOdalBox)); // commented by DEN - the one and only change of the file (event should be added to all JLMS ondomready event list after including this js file)