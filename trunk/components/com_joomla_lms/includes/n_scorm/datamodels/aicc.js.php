...
?>
    ...
    function StoreData(data,storetotaltime) {
		...
		$dreq_link = sefRelToAbs("index.php?option=$option&Itemid=$Itemid&task=datamodel_scorm");
        // 03 July (DEN)
        // This code is loading under index2.php - ArtioSEF not correctly working under index2.php - SefRelToAbs not working - it only replaces '&' to '&amp;'
        // '&amp;' - is not allowed here!!!!
        // Patch:
        $dreq_link = str_replace('&amp;', '&', $dreq_link);
		?>
