	...
	class Text
	{
		...
		*/
		...
		function Text()
		{
			...
			$this->fontCondensed = dirname(__FILE__) . "/../../../../../media/DejaVuSansCondensed.ttf";
			$this->fontCondensedBold = dirname(__FILE__) . "/../../../../../media/DejaVuSansCondensed_Bold.ttf";
		}
		...
		*/
		...
		function printDiagonal_per($img, $px, $py, $color, $text, $fontFileName = null, $columnWidth = 0)
                {
			...
			if ($fontFileName == null)
						...
						if (intval($columnWidth) > 0 && $textWidth > $columnWidth) {						
							$text = chunk_split($text, intval($columnWidth/6));
							$px = $px + 5;
						}
